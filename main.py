...
def start(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Repo 🔰', url="https://t.me/RynaZenaida")]]
...
def tiktok_dl(client, message):
    ...
    headers = {
      ...
      'x-rapidapi-key': "6f5284dcb1msh746532d1f04455ep10ec4cjsne9d65a174e8d"
    }
